    ...
    <div class="row">
        ...
        <div class="col">
            <h2 class="text-center" style="color: rgb(0,0,0);font-weight: bold; font-family: 'poppins';">
                <span style="text-decoration: underline;">REGULARISATION</span>
            </h2>
            <div class="card shadow-lg o-hidden border-0 my-5 regularisation-form">
                <div class="card-body p-0 pay-facture">
                    <div class="row">
                        <div class="col-lg-12 col-xl-12">
                            <div class="p-5" style="height: 500px;">
                                <p class="text-center">Veuillez remplir le formulaire ci-dessous pour effectuer une regularisation<br></p>
                                <hr>
                                <form class="user" style="margin-top: 10%;" method="POST" action="{{ route('annulation.store') }}">
                                    ...
                                    <input type="hidden" name="type" value="regularisation">
